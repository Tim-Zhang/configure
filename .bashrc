...
if [ -x /usr/bin/dircolors ]; then
   ...
   #dnspod website quick enter
   alias cdapp='cd ~/git/web/app'
   alias cdjs='cd ~/git/web/www/yantai/js'
   alias cdv='cd ~/git/web/app/views/scripts/'
   alias cdm='cd ~/git/web/app/models/'
